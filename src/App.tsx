					...
					<Route
						...
						element={
							<ProtectedRoute
								...
								isAllowed={login.user && login.user.token}
							>
								<ProfilePageComponent profileData={profileData} setProfileData={setProfileData} />
							</ProtectedRoute>
						}
					/>
					...
					<Route
						...
						element={
							<ProtectedRoute
								...
								isAllowed={login.user && login.user.token}
							>
								<PortfolioEditorPage profileData={profileData} setProfileData={setProfileData} />
							</ProtectedRoute>
						}
					/>
					...
					<Route
						...
						element={
							<ProtectedRoute
								...
								isAllowed={login.user && login.user.token}
							>
								<PortfolioViewPage profileData={profileData} setProfileData={setProfileData} />
							</ProtectedRoute>
						}
					/>
