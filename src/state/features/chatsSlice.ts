...
const getPrivateChatsAction = createAsyncThunk(
  "chat/getPrivate",
  async (username: string) => await getPrivateChatsByUserId(username)
);

const getPublicChatsAction = createAsyncThunk(
  "chat/getPublic",
  async (username: any) => await handleGetPublicChats(username)
);

const createChatsAction = createAsyncThunk(
  "chat/createChat",
  async (username: any, post: any) =>
    await createChatByUsername(username, null, post)
);
