...
const getImagesByImageIdsAction = createAsyncThunk(
  "images/images",
...
const getImageIdsByUsernameAction = createAsyncThunk(
  "images/ids",
  async (userData: any) => {
...
const getMapImagesByUserIdAction = createAsyncThunk(
  "images/map",
  async (payload: { username: string; nav?: boolean }) => {
    try {
...
const getAvatarsAction = createAsyncThunk(
  "images/avatars",
  async (friend: any) => {
...
const imagesSlice = createSlice({
  ...
  initialState,
  reducers: {
    setAvatars(state, action: PayloadAction<Image[]>) {
      state.avatars = action.payload;
    },
    setImages(state, action: PayloadAction<Image[]>) {
      state.images = action.payload;
    },
    setMapImages(state, action: PayloadAction<Image[]>) {
