...
const persistConfig = {
  ...
  whitelist: [
    "login",
    "livestreams",
    "livestreams/createStream",
    "profile",
    "device",
    "device/setCurrentBreakpoint",
    "device/toggleProfileMenu",
    "device/addMobileOverlay",
    "device/removeMobileOverlay",
    "device/setCurrentBreakpoint",
    "device/toggleProfileMenu",
    "device/addMobileOverlay",
    "device/removeMobileOverlay",
    ...
    "chat/add_message",
    "chat/delete_message",
    "chat/delete_messages_by_user_id",
    "chat/set_connection_state",
    "chat/set_chat_capabilities",
    "user",
    "user/setSessionValidity",
    "user/setUserData",
    "notify",
